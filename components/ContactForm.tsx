...
const fieldClass =
  "min-h-12 rounded-sm border border-line bg-white px-4 py-3 text-lg text-brand-navy outline-none transition placeholder:text-brand-navy/42 focus:border-brand-navy focus:shadow-[4px_4px_0_#F0CB30]";
